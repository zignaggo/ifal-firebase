import { Stack, Typography, useMediaQuery, Accordion, Avatar } from "@mui/material"
...
export const Student = () => {
  ...
  return (
    mobile ? <Accordion expanded={expanded == 'panel1'} onChange={handleChange('panel1')} >
      <AccordionSummary
      ...
      >
        <Stack paddingRight={1}>
          <Stack direction={"row"} paddingLeft={1} alignItems={"center"}>
            <Avatar />
            <Stack paddingLeft={1}>
              <Typography color={"grey.600"}>Luiz Vinícius Márdelle Costa Silva</Typography>
              <Typography color={"grey.500"}>CPF</Typography>
            </Stack>
          </Stack>
        </Stack>

        <Stack marginLeft={"auto"} marginTop={2} height={"100%"} justifyContent={"center"} paddingRight={2}>
          <Typography color={"grey.400"}>Situação</Typography>
        </Stack>
      </AccordionSummary>

      <AccordionDetails>
        <Stack paddingLeft={1} paddingRight={5} justifyContent={"space-between"} direction={"row"}>
          <Stack direction={"row"}>
      ...
      :
      <>
        <Stack paddingY={2} direction={"row"} borderRadius={2} justifyContent={"space-between"} paddingRight={5} bgcolor={"grey.50"}>
